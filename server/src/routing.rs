...
pub fn build_router(state: AppState) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route(endpoints::ACCOUNTS, get(get_accounts_page))
    ...
    let protected_routes = protected_routes.merge(
        Router::new()
            ...
            .route(endpoints::EDIT_ACCOUNT, put(edit_account_endpoint))
...
fn build_api_routes(state: AppState) -> Router<AppState> {
    Router::new()
        .route(budgeteur_shared::routes::DASHBOARD, get(get_dashboard_json))
